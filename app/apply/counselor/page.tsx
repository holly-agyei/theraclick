  ...
  return (
    <div className="flex h-screen min-h-[700px] overflow-hidden">
      ...
      <div className="relative hidden w-1/2 lg:block">
        ...
        <div className="absolute bottom-6 left-6 right-6 z-10 rounded-2xl border border-white/20 bg-white/10 p-5 backdrop-blur-xl">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-white">Support system, not hospital</p>
              <p className="mt-1 text-sm text-white/70">
                Theraklick is a layered support platform with strict confidentiality.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 flex flex-1 flex-col overflow-y-auto px-6 py-6 lg:px-10 lg:py-8">
          ...
          <div className="mx-auto w-full max-w-md flex-1">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-gray-700 bg-gray-800/50 px-4 py-2">
              ...
              <span className="text-sm font-medium text-gray-300">Counselor</span>
            </div>

            <h1 className="text-2xl font-bold tracking-tight text-white lg:text-3xl">Apply as Counselor</h1>
            ...
            <form onSubmit={handleSubmit} className="mt-5 space-y-3">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Anxiety, student counseling"
                  className="border-gray-700 bg-gray-800/50 text-white placeholder:text-gray-500"
                />
              </div>

              <div>
                <label className="mb-1 block text-sm font-medium text-gray-300">Credentials & experience</label>
                <textarea
                  value={about}
            ...
            <p className="mt-5 text-center text-sm text-gray-500">
              Already applied?{" "}
              <Link href="/login?role=counselor" className="font-semibold text-primary-400 hover:underline">
                Sign in
              </Link>
            </p>
          </div>
      ...
      <div className="fixed inset-0 -z-10 lg:hidden">
        <Image src="/images/counselor-hero.jpg" alt="Counselor" fill priority className="object-cover" sizes="100vw" />
