    ...
    async function loadData() {
      ...
      try {
        ...
        setStats({
          ...
          pendingBookings: bookingsList.length,
        });
      } catch (e) {
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="mb-8">
              <div className="mb-2 flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-blue-400">Counselor Dashboard</span>
              </div>
              <h1 className="text-3xl font-bold text-white md:text-4xl">
                Welcome, {profile?.fullName?.split(" ")[0] || "Dr."} 👋
              </h1>
              <p className="mt-2 text-gray-400">
                Manage your students, sessions, and support requests.
              </p>
            </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="mb-1 font-semibold text-white">All Students</h3>
                    <p className="text-sm text-gray-400">View and manage all students</p>
                  </div>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-gray-400">View all conversations</p>
                  </div>
                  <ChevronRight className="absolute bottom-5 right-5 h-5 w-5 text-gray-600 transition-all group-hover:translate-x-1 group-hover:text-white" />
                </button>
                ...
                <button
                  ...
                  className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 text-left backdrop-blur-sm transition-all hover:border-purple-500/30 hover:bg-white/10"
                >
                  <div className="absolute -right-8 -top-8 h-24 w-24 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 opacity-20 blur-2xl transition-opacity group-hover:opacity-40" />
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-gray-400">Manage your time slots</p>
                  </div>
                  <ChevronRight className="absolute bottom-5 right-5 h-5 w-5 text-gray-600 transition-all group-hover:translate-x-1 group-hover:text-white" />
                </button>
              </div>
                ...
                <div className="space-y-3">
                  {conversations.slice(0, 5).map((conv) => (
                    <button
                      ...
                      className="group w-full rounded-xl border border-white/10 bg-white/5 p-4 text-left transition-all hover:border-blue-500/30 hover:bg-white/10"
                    >
