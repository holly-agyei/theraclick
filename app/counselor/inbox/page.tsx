              ...
              <div className="space-y-3">
                {filteredConversations.map((conv) => (
                  <button
                    ...
                    className="group w-full rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 p-5 text-left transition-all hover:border-green-300 hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {conv.school && (
                          <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{conv.school}</p>
                        )}
                        {conv.lastMessage && (
