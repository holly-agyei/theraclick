              ...
              <div className="flex items-center gap-6">
                <div className="relative">
                  {profilePicture ? (
                    ...
                    <div className="h-24 w-24 rounded-full bg-green-600 flex items-center justify-center text-2xl font-bold text-white border-2 border-gray-200">
            ...
            <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-6">
              ...
              {editing ? (
                <div className="space-y-4">
                  <div>
                    <label className="mb-2 block text-sm font-medium text-gray-700">Specialization/Area</label>
                    <Input
