      ...
      <div className="min-h-screen bg-white dark:bg-gray-950">
        <div className="px-4 py-8 pb-28 md:px-8 md:py-10">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="mb-8 flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="rounded-lg border border-gray-200 dark:border-gray-700 p-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800"
                  aria-label="Inbox"
                >
                ...
                <div className="grid gap-4 sm:grid-cols-3">
                  {upcomingBookings.map((booking) => (
                    <button
                      key={booking.id}
                      onClick={() => router.push("/student/bookings")}
                      className="group rounded-xl border border-gray-200 dark:border-gray-800 bg-green-50/40 dark:bg-green-950/30 p-5 text-left transition-all hover:border-green-300 dark:hover:border-green-700 hover:shadow-sm"
                    >
                        ...
                        >
                          <td className="px-5 py-3.5">
                            <div className="flex items-center gap-3">
                              ...
                              <span className="font-medium text-gray-900 dark:text-gray-100">{conv.name}</span>
                            </div>
                          </td>
                ...
                {insightCards.map((card) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="mt-1 text-xs leading-relaxed text-gray-500 dark:text-gray-400">{card.body}</p>
                      {card.href && (
                        <a
                          href={card.href}
                          target="_blank"
            ...
            {/* Quick Reads */}
            <div className="mb-8">
              <h2 className="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Quick reads</h2>
              <div className="grid gap-4 sm:grid-cols-2">
                <a
                  href="https://www.who.int/news-room/fact-sheets/detail/mental-health-strengthening-our-response"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group flex items-center gap-3 rounded-xl border border-gray-200 dark:border-gray-800 p-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50"
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100 group-hover:text-green-600">
                      Mental Health: Facts & Figures
                    </p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">WHO Report</p>
                  </div>
                  <ArrowRight className="h-4 w-4 shrink-0 text-gray-300 dark:text-gray-600 group-hover:text-green-600" />
                </a>
                <a
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">Headspace</p>
                  </div>
                  <ArrowRight className="h-4 w-4 shrink-0 text-gray-300 dark:text-gray-600 group-hover:text-blue-600" />
                </a>
              </div>
            </div>
